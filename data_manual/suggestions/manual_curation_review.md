...
| --- | --- | --- | --- | --- | --- | --- |
| Science | homepage_or_scope | data_manual/pages/science_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found. |
| Science Advances | homepage_or_scope | data_manual/pages/science_advances_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found. |
| Science Advances | author_instructions | data_manual/pages/science_advances_information_for_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy.; Rejected data-policy candidate because summary was empty.; Rejected code-policy candidate because summary was empty.; APC amount not extracted confidently. |
| Cell | homepage_or_scope | data_manual/pages/cell_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found.; No clean aims/scope/about section found; scope tags omitted. |
| Cell | guide_for_authors | data_manual/pages/cell_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| Cell Host & Microbe | homepage_or_scope | data_manual/pages/cell_host_microbe_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found.; No clean aims/scope/about section found; scope tags omitted. |
| Cell Host & Microbe | guide_for_authors | data_manual/pages/cell_host_microbe_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| PNAS | homepage_or_scope | data_manual/pages/pnas_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| PNAS | author_instructions | data_manual/pages/pnas_submitting_your_manuscript.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy.; Rejected data-policy candidate because summary was empty.; Rejected code-policy candidate because summary was empty.; APC amount not extracted confidently. |
| mBio | homepage_or_scope | data_manual/pages/mbio_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| mBio | author_instructions | data_manual/pages/asm_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| mSystems | homepage_or_scope | data_manual/pages/msystems_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| mSystems | author_instructions | data_manual/pages/asm_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| Microbiology Spectrum | homepage_or_scope | data_manual/pages/microbiology_spectrum_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
...
| Briefings in Bioinformatics | homepage_or_scope | data_manual/pages/briefings_in_bioinformatics_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found.; No clean aims/scope/about section found; scope tags omitted. |
| NAR Genomics and Bioinformatics | homepage_or_scope | data_manual/pages/nar_genomics_and_bioinformatics_home.html | missing_relevant_section | homepage_url, aims_scope_url | - | No relevant article-type or author-instruction section found. |
...
| Viruses | author_instructions | data_manual/pages/viruses_instructions.html | ready_for_review | author_instructions_url, data_policy | - | Rejected code-policy candidate because summary was empty. |
| Viruses | apc | data_manual/pages/viruses_apc.html | ready_for_review | open_access | - | APC amount not extracted confidently. |
...
| PNAS | author_instructions | data_manual/pages/pnas_submitting_your_manuscript.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy.; Rejected data-policy candidate because summary was empty.; Rejected code-policy candidate because summary was empty.; APC amount not extracted confidently. |
| mBio | homepage_or_scope | data_manual/pages/mbio_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| mBio | apc | data_manual/pages/asm_publishing_fees.html | low_confidence | - | open_access | APC amount not extracted confidently. |
| mBio | author_instructions | data_manual/pages/asm_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| mSystems | homepage_or_scope | data_manual/pages/msystems_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| mSystems | apc | data_manual/pages/asm_publishing_fees.html | low_confidence | - | open_access | APC amount not extracted confidently. |
| mSystems | author_instructions | data_manual/pages/asm_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| Microbiology Spectrum | homepage_or_scope | data_manual/pages/microbiology_spectrum_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
| Microbiology Spectrum | apc | data_manual/pages/asm_publishing_fees.html | low_confidence | - | open_access | APC amount not extracted confidently. |
| Microbiology Spectrum | author_instructions | data_manual/pages/asm_authors.html | rejected_noise | author_instructions_url | - | Rejected article-type evidence because it looked noisy. |
| Applied and Environmental Microbiology | homepage_or_scope | data_manual/pages/aem_home.html | rejected_noise | homepage_url, aims_scope_url | - | Rejected article-type evidence because it looked noisy.; No clean aims/scope/about section found; scope tags omitted. |
...
| --- | --- |
| Nature | open_access.url |
| Science | open_access.url |
| Cell | open_access.url |
| Nature Microbiology | open_access.url |
| Nature Biotechnology | open_access.url |
| Nature Methods | open_access.url |
| Nature Communications | open_access.url |
| Cell Host & Microbe | open_access.url |
| Genome Biology | open_access.url |
| Genome Research | open_access.url |
| Microbiome | open_access.url |
| ISME Journal | open_access.url |
| ISME Communications | open_access.url |
| Microbial Genomics | open_access.url |
| Environmental Microbiology | open_access.url |
| Environmental Microbiome | open_access.url |
| FEMS Microbiology Ecology | open_access.url |
| Bioinformatics | open_access.url |
| Briefings in Bioinformatics | open_access.url |
| PLOS Computational Biology | open_access.url |
| NAR Genomics and Bioinformatics | open_access.url |
| GigaScience | open_access.url |
| BMC Bioinformatics | open_access.url |
| Virus Evolution | open_access.url |


## Recommended Action

More review is needed before running `--apply`; inspect the dry-run report and manually check substantive suggestions first.

## Machine-readable Recommendation

```yaml
safe_to_apply: false
reason: More review is needed before running `--apply`; inspect the dry-run report
  and manually check substantive suggestions first.
```
